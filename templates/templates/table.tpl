		...
		<tbody>
			...
			<tr class="warning" >
				...
				<form class="form-horizontal" method="post" action="admin.php"  >
					...
					<th width="80px">
					<a href="editor.php?subid={$sub.subid}"><button class="btn btn-primary glyphicon glyphicon-plus">新建资讯</button></a>
				</th>
			</tr>
			{/if}
			...
			<tr class="warning" >
				...
				<th width="80px"><input type='text' value='{$art.title}'></th>
				<th width="80px">
					<a href="editarticle.php?artid={$art.id}&subid={$sub.subid}"><button class="btn btn-success glyphicon glyphicon-edit "></button></a>
				</th>
				<th width="80px">
