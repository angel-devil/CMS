...
if(!empty($_POST['dbinfo']['dbhost']) && !empty($_POST['dbinfo']['dbuser']) && !empty($_POST['dbinfo']['dbpw']) && !empty($_POST['dbinfo']['dbname']) && !empty($_POST['admininfo']['password']) && !empty($_POST['admininfo']['password2']))
{
